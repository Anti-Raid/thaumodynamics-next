...
type={{
    id: {
      type: 'either AntiRaid or Discord',
      description: 'The base name of the event. This is either AntiRaid for AntiRaid events or Discord for Discord events.',
    },
    key: {
      type: 'string',
      description: 'The name of the event. This is the name of the event being dispatched. For example, KeyExpiry or MESSAGE_CREATE',
    },
    data: {
      type: 'any',
      description: 'The data associated with the event (also called the 'fields' of the event).. See the below sections for more information on the data associated with each event.
',
    },
  }}
/>
...
type={{
    id: {
      type: 'string',
      description: 'The unique ID of the key that resumed.',
    },
    key: {
      type: 'string',
      description: 'The name of the key that resumed.',
    },
    scopes: {
      type: 'string[]',
      description: 'The scopes the key belongs to.',
    },
  }}
/>
...
type={{
    author: {
      type: 'string',
      description: 'The user ID requesting the settings.',
    },
  }}
/>
...
type={{
    id: {
      type: 'string',
      description: 'The ID of the setting being executed.',
    },
    author: {
      type: 'string',
    ...
    op: {
      type: 'string',
      description: 'The operation (e.g., `View`, `Create`, `Update`, `Reorder`).',
    },
    fields: {
      type: 'any',
