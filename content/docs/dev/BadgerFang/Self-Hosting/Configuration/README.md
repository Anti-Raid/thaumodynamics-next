...
While most of the Image-Based assets are located at static folder, those aren't the only things you'll need to edit if you want to completely self host this website.
