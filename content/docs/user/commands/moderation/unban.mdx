...
<Steps>
  <Step>
    ### Identify the user Make sure you have the correct user ID you want to
    unban
  </Step>
  <Step>
    ### Run the unban command Use `/moderation unban user:@username` with any
    desired options
  </Step>
  <Step>
  ...
  <Step>
    ### Verify the unban Check that the user has been successfully unbanned
  </Step>
</Steps>
