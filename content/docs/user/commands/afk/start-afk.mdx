...
<Steps>
 <Step>
### Use the /afk Command
Run `/afk` with or without a reason
 </Step>
 <Step>
### Provide a Reason
Add a reason to let others know why you're away and possibly when you'll return
 </Step>
 <Step>
### Confirmation
The bot will confirm your AFK status is set
 </Step>
</Steps>
